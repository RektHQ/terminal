    ...
    <div className="w-full z-10">
      <div className="flex items-center justify-between bg-black border-b border-red-500/30 p-2">
        <div className="flex items-center">
          ...
          {/* Subscriber count */}
          <div className={`ml-4 flex items-center ${theme === "hacker" ? "text-green-500" : "text-blue-400"} text-xs`}>
          ...
          {isMobile ? (
            ...
            <>
              ...
              <button
                ...
                className={`${theme === "hacker" ? "bg-green-900/30 text-green-500 hover:bg-green-900/50" : "bg-blue-900/30 text-blue-400 hover:bg-blue-900/50"} px-2 py-1 rounded text-xs flex items-center`}
              >
      ...
      {isMobile && showMobileMenu && (
        <div className="bg-black border-b border-gray-800 p-2 z-50">
          <div className="flex flex-col space-y-3">
            ...
            <button
              onClick={handleAIConsoleClick}
              className={`flex items-center ${theme === "hacker" ? "text-green-500" : "text-blue-400"} text-left`}
            >
