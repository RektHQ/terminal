...
export function SubscriptionBanner() {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <Crown className={theme === "hacker" ? "text-yellow-500 mr-2" : "text-white mr-2"} size={18} />
      ...
      {showSubscriptionPage && <SubscriptionPage onClose={() => setShowSubscriptionPage(false)} />}

      {showReferralPage && <ReferralPage onClose={() => setShowReferralPage(false)} />}
    </>
  )
}
